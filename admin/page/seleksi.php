  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            Apakah anda ingn menghapus data dengan kode pendaftar =  <span class='nama'></span>?
        </div>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="terima.php?id=<?php echo $r[0]  ?>"><button type="button" class="btn btn-warning"><span class='fa fa-user'></span> Terima</button></a>
             <a href="tolak.php?id=<?php echo $r[0]  ?>" ><button type="button" class="btn btn-danger"><span class='fa fa-user'></span> Tolak</button></a>
             <a href="dipertimbangkan.php?id=<?php echo $r[0]  ?>" ><button type="button" class="btn btn-success"><span class='fa fa-user'></span> Dipertimbangkan</button></a>
