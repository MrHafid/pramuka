  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            Apakah anda ingn menghapus data pendaftar <b> <span class='nama'></span></b> ?
        </div>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a>&nbsp;<button class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg<?php echo $r[0]; ?>">Detail</button></a>
