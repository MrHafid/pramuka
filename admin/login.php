...
<html lang="en">
	...
	<body class="login-layout blur-login bg-blue">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">PENDAFTARAN SASDIK</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; GUDEP SASDIK SCOUT SMK NEGERI 1 LUMAJANG</h4>
							</div>
